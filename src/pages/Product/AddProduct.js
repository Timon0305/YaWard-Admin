...
class AddProduct extends Component {
    ...
    handleSubmit(event, values) {
        ...
        axios.post(url + 'addProduct', this.state, {
            headers: {
                'Authorization': token
            }
        }).then(res => {
    ...
    render() {
        ...
        for (let i = 0; i < vendors.length; i++) {
            ...
            itemVendor.push(<option key={i} value={vendorId}>{vendorName}</option>)
        }
                    ...
                    <Container fluid>
                        ...
                        <Row>
                            <Col lg="12">
                                <Card>
                                    <CardBody>
                                        <CardTitle className="mb-4">Add Products</CardTitle>
                                        <AvForm onValidSubmit={this.handleSubmit}>
                                            ...
                                            <FormGroup className="mb-4" row>
                                                <label htmlFor="image" className="col-form-label col-lg-2">Select Vendor</label>
                                                <Col lg="10">
                                                    <AvField type="select" name='vendorName' value={this.state.vendorId}
                                                             onChange={this.handleInputChange}>
                                            ...
                                            <Row className="justify-content-end">
                                                <Col lg="10">
                                                    <Button type="submit" color="primary">Upload Product</Button>
