                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                        ...
                                        <div className="p-2">
                                            ...
                                            <AvForm className="form-horizontal" onValidSubmit={this.handleValidSubmit}>
                                                ...
                                                <div className="mt-4 text-center">
                                                    <Link to="/forgot-password" className="text-muted"><i className="mdi mdi-lock mr-1"/> Forgot your password?</Link>
                                                </div>
                                            </AvForm>
                                        </div>
                                    </CardBody>
                                ...
                                <div className="mt-5 text-center">
                                    ...
                                    <p>© {new Date().getFullYear()} YaWard. Crafted with <i className="mdi mdi-heart text-danger"/> by Samer</p>
                                </div>
                            </Col>
                        </Row>
                    </Container>
